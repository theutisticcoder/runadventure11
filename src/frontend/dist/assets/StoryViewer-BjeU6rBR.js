import { c as createLucideIcon, o, r as reactExports, v as vt, g as useParams, j as jsxRuntimeExports, B as BookOpen, L as Link, d as Button, M as MapPin, e as Skeleton } from "./index-DMIBnIiZ.js";
import { B as Badge, a as GENRE_COLORS, b as GENRE_BG_COLORS, c as GENRE_GLOW } from "./types-HpiJbp6e.js";
import { L } from "./leaflet-src-Ceggw5tJ.js";
import { c as useRunBySlug } from "./useBackend-CZ7kvxeE.js";
import { C as ChevronLeft, R as Route, a as Clock } from "./route-BsBW-tLz.js";
import { U as User } from "./user-BodCJ_hc.js";
/**
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = o.useState(null), [lt, J] = o.useState(null), [W, H] = o.useState(false), [A, mt] = o.useState(false), [L2, z] = o.useState(false), [ct, d] = o.useState(false), [h, y] = o.useState(false), [R, j] = o.useState(0), [p, _] = o.useState(0), O = o.useRef(t.duration || X || Wt), G = o.useRef(null), k = o.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = o.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = o.useMemo(() => {
    var r;
...
function RouteMap({ gpsRoute, chapterCoords, genreColor }) {
  const containerRef = reactExports.useRef(null);
  const mapRef = reactExports.useRef(null);
  const lineColor = genreColor.includes("amber") ? "#fbbf24" : genreColor.includes("cyan") ? "#22d3ee" : genreColor.includes("red") ? "#ef4444" : genreColor.includes("purple") ? "#a78bfa" : genreColor.includes("rose") ? "#fb7185" : "#f59e0b";
...
function ChapterCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/50 bg-card overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 border-b border-border/30 px-4 py-3 flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-accent/20 text-accent text-sm font-bold flex items-center justify-center flex-shrink-0 mt-0.5", children: chapterNum }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display font-semibold text-base text-foreground leading-tight", children: [
                "At the corner of ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: street1 }),
                " & ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: street2 })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base leading-relaxed text-foreground font-body", children: text }) })
        ] }),
        !isLast && choiceMade && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center gap-3 px-2 py-3",
            "data-ocid": `chapter-choice-${chapterNum}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0.5 h-full bg-border/40 min-h-[28px]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-muted/20 border border-border/30 rounded-lg px-3 py-2 flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 14, className: "text-accent flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground", children: [
                  "Runner chose:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: choiceMade })
                ] })
              ] })
            ]
          }
...
function StoryViewer() {
  ...
  if (!run) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-muted/30 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 36, className: "text-muted-foreground/50" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground mb-3", children: "Adventure Not Found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-xs mb-8 leading-relaxed", children: "This story may have been removed or the link is no longer valid." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/feed", search: { my: false }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2 min-h-[44px]", children: [
  ...
  const chapterCoords = run.chapters.map((_, i) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border/40 px-4 pt-4 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-lg mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground leading-tight", children: run.title }),
          run.userName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-1.5 flex items-center gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 text-xs text-muted-foreground flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { size: 13 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-screen-lg mx-auto w-full px-4 py-6 flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 15, className: "text-accent" }),
            "Copied!"
      ...
      showMap && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "GPS route map", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        RouteMap,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Story chapters", children: run.chapters.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-0", "data-ocid": "chapters-list", children: run.chapters.map((chapter, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ChapterCard,
        {
          chapterNum: i + 1,
        ...
        `chapter-${chapter.streetName1}-${chapter.streetName2}-${String(i)}`
      )) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 36, className: "mb-4 opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base", children: "No chapters recorded for this adventure." })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Want to write your own adventure?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/run", search: { genre: void 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
